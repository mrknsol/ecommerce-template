...
const Footer = () => {
  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="space-y-8">
      <h1 class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">E-commerce</h1>
        <p class="text-sm leading-6 text-gray-600">Making everything look better to the world and a more modern design.</p>
        <div class="flex space-x-6">
          ...
          <a href="#" class="text-yellow-500 hover:text-gray-500">
            <span class="sr-only">the site is on fire</span>
